    ...
    */
    {
        ...
        name: 'Entrance',
        component: () => import('../views/Entrance.vue'),
        meta: { title: 'MiSub-lite', isPublic: true } // Public, so Entrance.vue can decide what to render
    }
];
...
router.beforeEach(async (to, from, next) => {
    ...
    if (typeof document !== 'undefined') {
        document.title = to.meta.title ? `${to.meta.title} - MiSub-lite` : 'MiSub-lite';
    }
